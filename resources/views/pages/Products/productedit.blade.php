                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('product.update',$product->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" id="formFile" name="main_image" value="{{old('main_image',$product->main_image)}}">
                                    @error('main_image')
                                    <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    @for ($i = 0; $i < 5; $i++)
                                        <input class="form-control" type="file" id="formFile" name="sub_images[]" value="{{old('sub_images',$product->sub_image_)}}">
                                        @endfor
                                </div>
                            </div>
